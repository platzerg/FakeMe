package com.platzerworld.tumblr.jumblr.types;
...
public class PhotoPost extends Post {
    ...
    public void setPhoto(Photo photo) {
        ...
        } else if (postType == Photo.PhotoType.SOURCE && pendingPhotos.size() > 0) {
    ...
    public Map<String, Object> detail() {
        ...
        if (pendingPhotos != null && pendingPhotos.size() > 0) {
            Photo.PhotoType type = pendingPhotos.get(0).getType();
