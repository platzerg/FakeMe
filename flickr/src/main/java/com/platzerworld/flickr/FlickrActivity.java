...
import com.platzerworld.flickr.tasks.GetOAuthTokenTask;
import com.platzerworld.flickr.tasks.LoadPhotostreamTask;
import com.platzerworld.flickr.tasks.LoadUserTask;
import com.platzerworld.flickr.tasks.OAuthTask;
...
public class FlickrActivity extends Activity {
    ...
    public static final String KEY_USER_NAME = "8ff3556f9763aea9ac2c909f88977984"; //$NON-NLS-1$
    public static final String KEY_USER_ID = "da0d18c6bc2fb1b0"; //$NON-NLS-1$
