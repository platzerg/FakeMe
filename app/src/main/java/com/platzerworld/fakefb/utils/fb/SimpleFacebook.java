package com.platzerworld.fakefb.utils.fb;
...
import com.platzerworld.fakefb.utils.actions.DeleteRequestAction;
import com.platzerworld.fakefb.utils.actions.GetAccountsAction;
import com.platzerworld.fakefb.utils.actions.GetAction;
import com.platzerworld.fakefb.utils.actions.GetAlbumsAction;
import com.platzerworld.fakefb.utils.actions.GetAppRequestsAction;
import com.platzerworld.fakefb.utils.actions.GetCheckinsAction;
import com.platzerworld.fakefb.utils.actions.GetCommentsAction;
import com.platzerworld.fakefb.utils.actions.GetEventsAction;
import com.platzerworld.fakefb.utils.actions.GetFamilyAction;
import com.platzerworld.fakefb.utils.actions.GetFriendsAction;
import com.platzerworld.fakefb.utils.actions.GetGroupsAction;
import com.platzerworld.fakefb.utils.actions.GetInvitableFriendsAction;
import com.platzerworld.fakefb.utils.actions.GetLikesAction;
import com.platzerworld.fakefb.utils.actions.GetNotificationsAction;
import com.platzerworld.fakefb.utils.actions.GetPageAction;
import com.platzerworld.fakefb.utils.actions.GetPagesAction;
import com.platzerworld.fakefb.utils.actions.GetPhotosAction;
import com.platzerworld.fakefb.utils.actions.GetPostsAction;
import com.platzerworld.fakefb.utils.actions.GetProfileAction;
import com.platzerworld.fakefb.utils.actions.GetScoresAction;
import com.platzerworld.fakefb.utils.actions.GetStoryObjectsAction;
import com.platzerworld.fakefb.utils.actions.GetTaggableFriendsAction;
import com.platzerworld.fakefb.utils.actions.GetVideosAction;
import com.platzerworld.fakefb.utils.actions.InviteAction;
import com.platzerworld.fakefb.utils.actions.PublishAction;
import com.platzerworld.fakefb.utils.actions.PublishFeedDialogAction;
import com.platzerworld.fakefb.utils.entities.Album;
import com.platzerworld.fakefb.utils.entities.Checkin;
import com.platzerworld.fakefb.utils.entities.Event.EventDecision;
import com.platzerworld.fakefb.utils.entities.Feed;
...
import com.platzerworld.fakefb.utils.entities.Publishable;
import com.platzerworld.fakefb.utils.entities.Score;
import com.platzerworld.fakefb.utils.entities.Story;
import com.platzerworld.fakefb.utils.entities.Story.StoryObject;
import com.platzerworld.fakefb.utils.entities.Video;
import com.platzerworld.fakefb.utils.listeners.OnAccountsListener;
import com.platzerworld.fakefb.utils.listeners.OnActionListener;
import com.platzerworld.fakefb.utils.listeners.OnAlbumsListener;
import com.platzerworld.fakefb.utils.listeners.OnAppRequestsListener;
import com.platzerworld.fakefb.utils.listeners.OnCheckinsListener;
import com.platzerworld.fakefb.utils.listeners.OnCommentsListener;
import com.platzerworld.fakefb.utils.listeners.OnCreateStoryObject;
import com.platzerworld.fakefb.utils.listeners.OnDeleteListener;
import com.platzerworld.fakefb.utils.listeners.OnEventsListener;
import com.platzerworld.fakefb.utils.listeners.OnFamilyListener;
import com.platzerworld.fakefb.utils.listeners.OnFriendsListener;
import com.platzerworld.fakefb.utils.listeners.OnGroupsListener;
import com.platzerworld.fakefb.utils.listeners.OnInviteListener;
import com.platzerworld.fakefb.utils.listeners.OnLikesListener;
import com.platzerworld.fakefb.utils.listeners.OnLoginListener;
import com.platzerworld.fakefb.utils.listeners.OnLogoutListener;
import com.platzerworld.fakefb.utils.listeners.OnNewPermissionsListener;
import com.platzerworld.fakefb.utils.listeners.OnNotificationsListener;
import com.platzerworld.fakefb.utils.listeners.OnPageListener;
import com.platzerworld.fakefb.utils.listeners.OnPagesListener;
import com.platzerworld.fakefb.utils.listeners.OnPhotosListener;
import com.platzerworld.fakefb.utils.listeners.OnPostsListener;
import com.platzerworld.fakefb.utils.listeners.OnProfileListener;
import com.platzerworld.fakefb.utils.listeners.OnPublishListener;
import com.platzerworld.fakefb.utils.listeners.OnScoresListener;
import com.platzerworld.fakefb.utils.listeners.OnStoryObjectsListener;
import com.platzerworld.fakefb.utils.listeners.OnVideosListener;
...
public class SimpleFacebook {
	 ...
	 * get an instance of this library by {@link com.platzerworld.fakefb.utils.fb.SimpleFacebook#getInstance()}
	 * in any other place.
	 * 
	 * @param activity
	 *            Activity
	...
	/**
	 * Get the instance of {@link com.platzerworld.fakefb.utils.fb.SimpleFacebook}. This method, not only returns
	 * a singleton instance of {@link com.platzerworld.fakefb.utils.fb.SimpleFacebook} but also updates the
	 ...
	 * 
	 * @param activity
	 * @return {@link com.platzerworld.fakefb.utils.fb.SimpleFacebook} instance
	 */
	...
	/**
	 * Get the instance of {@link com.platzerworld.fakefb.utils.fb.SimpleFacebook}. <br>
	 * <br>
	 ...
	 * 
	 * @return The {@link com.platzerworld.fakefb.utils.fb.SimpleFacebook} instance
	 */
	 ...
	 * 
	 * <b>Permission:</b><br>
	 * {@link com.platzerworld.fakefb.utils.fb.Permission#USER_PHOTOS}
	 * 
	 ...
	 * 
	 * <b>Permission:</b><br>
	 * {@link com.platzerworld.fakefb.utils.fb.Permission#USER_PHOTOS}<br>
	 * 
	 * @param entityId
	 ...
	 * 
	 * <b>Permission:</b><br>
	 * {@link com.platzerworld.fakefb.utils.fb.Permission#USER_LIKES}<br>
	 * 
	 ...
	 * 
	 * <b>Permission:</b><br>
	 * {@link com.platzerworld.fakefb.utils.fb.Permission#USER_CHECKINS}<br>
	 * 
	 ...
	 * album, you need to have the {@link com.platzerworld.fakefb.utils.fb.Permission#USER_PHOTOS} for getting the comments of this album.
	 * 
	 * @param entityId
	 ...
	 * 
	 * <b>Permission:</b><br>
	 * {@link com.platzerworld.fakefb.utils.fb.Permission#USER_EVENTS}<br>
	 * 
	 * @param eventDecision
	 ...
	 * 
	 * <b>Permission:</b><br>
	 * {@link com.platzerworld.fakefb.utils.fb.Permission#USER_RELATIONSHIPS}<br>
	 * 
	 ...
	 * 
	 * <b>Permission:</b><br>
	 * {@link com.platzerworld.fakefb.utils.fb.Permission#USER_GROUPS}
	 * 
	 ...
	 * 
	 * <b>Permission:</b><br>
	 * {@link com.platzerworld.fakefb.utils.fb.Permission#USER_GROUPS}<br>
	 * 
	 * @param entityId
	 *            Profile
	 * @param onGroupsListener
	 ...
	 * album, you need to have the {@link com.platzerworld.fakefb.utils.fb.Permission#USER_PHOTOS} for getting likes of this album.
	 * 
	 * @param entityId
	 *            Album, Checkin, Comment, Link, Photo, Post or Video.
	 * @param onCommentsListener
	 ...
	 * 
	 * <b>Permission:</b><br>
	 * {@link com.platzerworld.fakefb.utils.fb.Permission#MANAGE_NOTIFICATIONS}<br>
	 * 
	 ...
	 * {@link com.platzerworld.fakefb.utils.fb.Permission#READ_STREAM}
	 * 
	 ...
	 * No special permissions are needed for getting the public posts. If you
	 * want to get more private posts, then you need
	 * {@link com.platzerworld.fakefb.utils.fb.Permission#READ_STREAM}<br>
	 * <br>
	 * 
	 * @param entityId
	 ...
	 * 
	 * <b>Permission:</b><br>
	 * {@link com.platzerworld.fakefb.utils.fb.Permission#USER_VIDEOS}
	 * 
	 ...
	 * 
	 * <b>Permission:</b><br>
	 * {@link com.platzerworld.fakefb.utils.fb.Permission#USER_VIDEOS}<br>
	 * 
	 * @param entityId
	 *            Profile, Page, Event
	 * @param onVideosListener
	 ...
	 * 
	 * <b>Permission:</b><br>
	 * {@link com.platzerworld.fakefb.utils.fb.Permission#PUBLISH_ACTION}
	 * 
	 * 
	 * @param score
	 ...
	 * page. Then you will have to ask for {@link com.platzerworld.fakefb.utils.fb.Permission#MANAGE_PAGES}
	 * permission in addition to {@link com.platzerworld.fakefb.utils.fb.Permission#PUBLISH_ACTION}.<br>
	 * 
	 * @param entityId
	 *            Group, Event, Page
	 * @param feed
	 ...
	 * {@link com.platzerworld.fakefb.utils.fb.Permission#PUBLISH_ACTION} since user does the share by himself.<br>
	 * <br>
	 * <b>Important:</b><br>
...
//	}
	 ...
	 * 
	 * <b>Permission:</b><br>
	 * {@link com.platzerworld.fakefb.utils.fb.Permission#PUBLISH_STREAM}<br>
	 * <br>
	 * 
	 * <b>Important:</b><br>
	 ...
	 * Use {@link com.platzerworld.fakefb.utils.fb.Permission#fromValue(String)} to get the {@link com.platzerworld.fakefb.utils.fb.Permission}
